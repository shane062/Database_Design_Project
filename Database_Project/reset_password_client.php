<?php 
	...
	if(isset($_POST['reset_password_client'])) {
		...
		echo '<script>alert("Updated successfully");</script>
		      <script>window.location.href="manage_client.php";</script>';
	}
?>
<!DOCTYPE html>
<html lang="en-US">
    ...
    <body>
		...
		<a style="padding-left:20px;" href="manage_client.php">Back</a>
		...
		<center>
			...
			<form method=POST action="<?php echo $_SERVER['PHP_SELF']; ?>">
				...
				<input type="submit" name="reset_password_client" value="Reset Password"/>
			</form>
		</center>
    </body>
</html>